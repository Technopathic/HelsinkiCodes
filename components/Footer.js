    ...
    return (
        <Container className="w-full flex flex-col lg:py-24 py-12">
            <Grid className="w-full max-w-screen-xl m-auto grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:gap-14 gap-8 lg:pb-24 xl:px-0 lg:px-8 pb-12 px-4">
                <NavBlock href={process.env.YOUTUBE} target="_blank" rel="noopener noreferrer" className="bg-hcDarkGrayBrand">
                    <section className="w-1/2 h-full">
                        <FaYoutube size={260} className="-ml-14 -mt-9 opacity-90" />
                    </section>
                ...
                <Link href="/about" passHref>
                    <NavBlock className="bg-hcDarkGrayBrand">
            ...
            <section className="w-full max-w-screen-xl m-auto flex lg:flex-row flex-col flex-grow justify-between pt-12 p-8">
                <section className="flex flex-col">
                    <span className="text-gray-200">
                        <img src="/site-images/Square-HC-Logo-White-128.png" className="h-20 w-20 mb-8" />
                    </span>
                    <div className="flex text-gray-400 items-center flex-wrap">Made with&nbsp;<span className="text-pink-500">❤</span>&nbsp;in Helsinki</div>
                ...
                <section className="grid md:grid-cols-3 gap-8 grid-cols-2 lg:mt-0 mt-8">
                    ...
                    <div className="flex flex-col">
                        ...
                        <Link href="/about" passHref><a className="no-underline text-sm mb-2 text-gray-400">About</a></Link>
