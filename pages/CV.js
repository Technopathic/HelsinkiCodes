    ...
    <Main>
        ...
        <Header>
            <HeaderCircle>
                ...
                <HeaderDivider className="bg-darkGrayBrand dark:bg-white" />
        ...
        <div className="w-full flex flex-col justify-between mb-6 md:flex-row">
            <div className="flex flex-col w-full md:w-7/12 mr-2">
                <div className="flex items-center relative mb-4">
                    <span className="text-xl uppercase font-bold">Profile</span>
                    <Tread />
                </div>
            ...
            <div className="flex flex-col w-full md:w-4/12">
                <div className="flex items-center relative mb-4">
                    <span className="text-xl uppercase font-bold">Personal</span>
                    <Tread />
                </div>
        ...
        <div className="w-full flex flex-col mb-6">
            <div className="flex items-center relative mb-6">
                <span className="text-xl uppercase font-bold">Experience</span>
                <Tread />
            </div>
        ...
        <div className="w-full flex flex-col mb-6">
            <div className="flex items-center relative mb-6">
                <span className="text-xl uppercase font-bold">Portfolio</span>
                <Tread />
            </div>
        ...
        <div className="w-full flex flex-col mb-6">
            <div className="flex items-center relative mb-6">
                <span className="text-xl uppercase font-bold">Writings</span>
                <Tread />
            </div>
            <div className="flex flex-col md:flex-row flex-wrap">
