...
const Privacy = () => (
    <>
        ...
        <div className="w-full max-w-screen-md my-32 mx-auto">
            ...
            <p>This privacy policy explains what personal data Helsinki Codes collects on you when you participate in Helsinki Codes (herein the "app") and how such data is used.</p>
            ...
            <p>Helsinki Codes registers and uses information about you (personal data).</p>

            <p>Helsinki Codes is responsible for processing the personal data you provide in connection with your use of Helsinki Codes and the Platform. Although Helsinki Codes is the data controller, Helsinki Codes stores your information with Supabase.</p>

            <p>Helsinki Codes will not disclose your infromation to others without your explicit consent except as explicity set out below.</p>

            <p>Helsinki Codes protects your data and privacy by taking all relevant measures in accordance with applicable legislation, especially the General Data Protection Regulation (EU) 2016/679 ("GDPR").</p>
            ...
            <p>Helsinki Codes also uses the information for administrative purposes and to improve the Services Helsinki Codes now has and will provide in the future. Helsinki Codes may furthermore use information about your input and use Helsinki Codes for targeted improvement of Helsinki Code's services. Finally, Helsinki Codes may use your data for statistical purposes.</p>

            <h3>When do we register and use your personal data?</h3>
            <p>We register your personal data when you provide it to Helsinki Codes.</p>
            ...
            <ul>
                ...
                <li>it is necessary to pursue a legitimate interest of Helsinki Codes pursuant to article 6(1)(f) of GDPR. For example, this may be to prevent abuse and loss, to strengthen our IT-solution. We will only do so if our interest clearly outweighs your interest in not having your personal data processed by us.</li>
            </ul>

            <h3>Which personal ddata do we register and use?</h3>
            <p>When you create a user profile at Helsinki Codes, Helsinki Codes will request a variety of information from you, including your name and email address. This information will either be requested by site form or obtained from a user's associated social media account when using Single Sign On. Helsinki Codes uses this information to make the services available to you. You may alway ask Helsinki Codes to inform you of which inforation Helsinki Codes has registered about you. You may also at any time demand Helsinki Codes deletes information registered about you. If it turns out that Helsinki Codes' information about you is incorrect, you may request the information about you is updated by Helsinki Codes. In order to perform these corrections, it may be necessary to validate a user by their e-mail address.</p>
            ...
            <p>We do not use automated decision-making in Helsinki Codes</p>
            ...
            <h3>Correction or erasure of your personal data in Helsinki Codes</h3>
            <p>If the data is incorrect, incomplete or irrelevant, you are entitled to have the data corrected or erased. These rights are known as the "right to rectification", "right to erasure", or "right to be forgotten" and Helsinki Codes provides you with the means to rectify or delete your data.</p>
            ...
            <p>Our self-service solutions use session cookies to make sure that you navigate on the site and use the solutions and tools presented on the site. This means that you cannot use Helsinki Codes apps without session cookies. You cannot disable these cookies while using our self-service solutions, but they will disappear when you log off a solution.</p>
            ...
            <ul>
                <li>Helsinki Codes pages you looked at and the date and time you looked at them</li>
                <li>the browser you are using</li>
                <li>your screen resolution</li>
                <il>your operating system</il>
            </ul>
