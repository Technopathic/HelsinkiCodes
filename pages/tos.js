const TOS = () => (
    <div className="w-full max-w-screen-md my-32 mx-auto">
        ...
        <p>Welcome to the Helsinki Codes platform (the "Platform"). Helsinki Codes and the Platform is powered and owned by NowNano ("NowNano" / "Helsinki Codes"). By accessing, browsing or using this Platform, you acknowledge that you have read, understood and agree to be bound by these Terms of Use (the "Terms") as well as the Privacy Notice which sets out the way we manage your personal data (the "Privacy Notice"). If you do not agree to these Terms and the Privacy Notice, you should not use or access this Platform. Helsinki Codes reserves the right to revise these Terms at any time by updating this posting. You are encouraged to review these Terms frequently because your use of the Platform after the posting of changes will constitute your acceptance of the changes. When changes are done to the Terms or the Privacy Notice we will send a notice to you of this by e-mail if available. We grant you a personal, limited, non-transferable non-exclusive, license to access and use the Platform. We reserve the right, in our sole discretion and without notice to you, to revise the products and services available on the Platform and to change, suspend or discontinue any aspect of the Platform and we will not be liable to you or to any third party for doing so. We may also impose rules for and limits on use on the use of the Platform or restrict your access to part, or all, of the Platform without notice or penalty if you in our opinion in any way misuse the Platform or we change teh focus of the Platform. Your continued use of the Platform will constitute your acceptance to any such changes.</p>

        "Helsinki Codes" and/or "HelsinkiCodes" as mentioned refers to <a href="https://helsinki.codes">helsinki.codes</a>.

        <p>For the time being Helsinki Codes offers the below services (the "Services") on the Platform</p>

        <h3>News and Current events for Game and IT industry</h3>
        <p>The contents of the news and current events have been created by Helsinki Codes. This content is for informational and educational purposes in order to create an overview of the video game and information technology fields. It has been prepared independently, from publically available information believed to be reliable as well as from the best practices and experience from Helsinki Codes and does not necessarily reflect the views of others. The overview given on the Platform are entirely those of Helsinki Codes and refelecting their view on the topic. It does not constitute, or form part of, any offer nor should it or any part of it form the basis of, or be relied on in any connection with any contract or commitment whatsoever. The contents of the Platform may not be construed in any way to be binding advice or strictly followed. Whilst reasonable care has been taken to ensure that its contents are not untrue or misleading, no representation is made as to its accuracy, completeness or correctness of the information and opinions contained on the Platform and no liability is accepted for any loss arising from your reliance on it. Users should not solely rely on the provided information but should seek independent advice whenever necessary. The information and views given on the Platform are subject to change without notice. The Platform is protected by copyright and is being supplied to you solely for your information and may not be reproduced or further distributed to any other person or published (in whole or in part) without permission from Helsinki Codes.</p>

        <p>Linked sites: Helsinki Codes has not reviewed and is not responsible for the content of off-site pages or any other sites linked to this site.</p>

        <p>No warranty: Helsinki Codes accepts no responsibility for, and makes no warranty that functions contained at this site will be uninterrupted or error-free. Helsinki Codes does not accept any liability for any direct or consequential loss arising from any use of the Platform or its contents, including any harm or defect caused by your computer as a result of access and use of the server that makes the Platform available.</p>
        ...
        <p>We refer to our Privacy Notice for you to know how we use data {process.env.PRIVACY_POLICY}</p>
        ...
        <p>Helsinki Codes is responsible for material published on the Platform. Helsinki Codes and its licensors reserve all right to ownership, copyright, trademarks and other intellectual property rights related to Helsinki Codes and the Platform and to products and Services mentioned or on the Platform, except as specifically set out in these Terms.</p>
        ...
        <p>Helsinki Codes does not claim ownership of any materials you make available through the Platform. With respect to any materials you submit or make available for inclusion on the Platform, you grant Helsinki Codes a perpetual, irrevocable, non-terminable, worldwide, royalty-free and non-exclusive license to use, copy, distribute, publically display, modify and create derivative works of such materials or any part of such materials for use on and in connection with Helsinki Codes. You hereby represent that you hold good and proper rights to any material (including, but not limited to, text, images, music, or video) which you provide to Helsinki Codes and the Platform. You further represent that any materials you provide will not contain libellous or otherwise unlawful, abusive or obscene material. Helsinki Codes will be entitled to use any content submitted by you without incurring obligations of confidentiality, attribution or compensation to you.</p>

        <ol>
            <li>Disclaimers</li>
        </ol>
        <p>You assume all responsibility and risk with respect to your use of the Platform.</p>
        <p>The Platfor, and all contents, and other information on or accessible from or through this platform or a "linked" platform are provided on an "as is" and "as available" basis without warranty of any kind, either express or implied, including but not limited to the implied warranties of merchantability, fitness for a particular purpose, non-infringement, security or accuracy. Specifically, but without limitation, Helsinki Codes does not warrant that: (1) The information on this platform is correct, acurate or reliable; (2) The functions contained on this platform will be uninterrupted or error-free; or (3) defects will be corrected, or that this platfor or the server that makes it available is free of viruses or other harmful coponents.</p>

        <p>Helsinki Codes makes no warranties of any kind regarding any non-Helsinki Codes platforms to which you may be directed or hyperlinked from this Platform. Hyperlinks are included solely for your convenience, and Helsinki Codes makes no representations or warranties with regard to the accuracy, availability, suitability or safety of information provided in such non-Helsinki Codes platforms. Helsinki Codes does not endorse, warrant or guarantee any products or services offered or provided by or on behalf of third parties on the Platform.</p>

        <ol>
            <li>Indemnification</li>
        </ol>
        <p>You agree to indemnify, hold harmless, and defend Helsinki Codes, their parents, subsidiaries, divisions, and affiliates, and their respective officers, directors, employees, agents and affiliates from any and all claims, liabilities, damages, costs and expenses of defense, including attorneys' fees, in any way arising from or related to your use of the Platform, your violation of these Terms or the Privacy Policy, content posted to the Platform by you, or your violation of any law or the rights of a third party.</p>

        <ol>
            <li>Limitation of Liability</li>
        </ol>
        <p>In no event shall Helsinki Codes, their affiliates or any of their respective officers, directors, employees, agents, successors, subsidaries, suppliers, affiliates, or third parties providing information on this platform by liable to any user of the Platform or any other person or entity for any direct, indirect, special, incidental, punitive, consequential or exemplary damages (including, but not limited to, damages for loss of profits, loss of data, or loss of use) arising out of the use or inability to use the platform, whether based upon warranty, contract, tort, or otherwise, even if Helsinki Codes has been advised of or should have known the possibility of such damages or losses. In no event shall the total liability of Helsinki Codes, their affiliates or any of their respective officers, directors, employees, agents, successors, subsidiaries, suppliers, affiliates or third parties providing information on this platform to you for all damages, losses, and causes of action resulting from your use of this platform, whether in contract, tort (including, but not limited to, negligence) or otherwise, exceed the amount you paid to Helsinki Codes in connection with the event giving rise to such liability.</p>
        ...
        <p>Although we believe the Platform to be free from viruses, malware and other errors that might affect your IT systems, you access and use the Platform at your own risk. Helsinki Codes assumes no responsibility for any loss or damage arising from the use of the Platform. Furthermore, the Helsinki Codes no responsibility for the availability of the Platform.</p>

        <p>Neither Helsinki Codes nor any of its officers and employees accept any liability for any damage or direct, indirect or consequential loss arising from the availability or use of the Platform, including any harm or defect caused to your computer as a result of accessing and using the IT systems that makes the Platform available.</p>

        <ol>
            <li>Choice of Law and Jurisdiction</li>
        </ol>
        <p>The laws of the local Platform you sign up to shall govern these terms, without giving effect to any principles that provide for the application of the law of another jurisdiction and any disputes that may occur shall be settled in the courts of the jurisdiction you sign up to. If you sign up at helsinki.codes, Finnish law and jurisdiction will apply.</p>
    </div>
)
