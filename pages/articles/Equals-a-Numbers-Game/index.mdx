...
export const meta = {
  ...
  description: "Let's look back on the history and inspiration of one of my longest running projects ever.",
  date: 'Nov 28, 2021',
  ...
  tagline: '',
  category: 'Game Dev',
  tags: ['game', 'web', 'editorial', 'nextjs'],
...
<Img src="/images/equals-a-numbers-game/mathica-1.PNG" alt="Mathica One" />
...
<Img src="/images/equals-a-numbers-game/mathica-2.PNG" alt="Mathica Two" />
...
<Img src="/images/equals-a-numbers-game/mathica-3.png" alt="Mathica Three" />
