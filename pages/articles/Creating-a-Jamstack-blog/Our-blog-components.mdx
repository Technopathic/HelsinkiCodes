...
<Code content={1} data={data} image="/image/blog-with-nextjs-guide/1.svg" />
...
<Code content={2} data={data} image="/image/blog-with-nextjs-guide/2.svg" />
...
<Code content={3} data={data} image="/image/blog-with-nextjs-guide/3.svg" />
...
<Code content={4} data={data} image="/image/blog-with-nextjs-guide/4.svg" />
...
<Code content={5} data={data} image="/image/blog-with-nextjs-guide/5.svg" />
...
<Code content={6} data={data} image="/image/blog-with-nextjs-guide/6.svg" />
...
<Code content={7} data={data} image="/image/blog-with-nextjs-guide/7.svg" />
...
<Code content={8} data={data} image="/image/blog-with-nextjs-guide/8.svg" />