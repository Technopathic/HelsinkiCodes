...
<Code content={16} data={data} image="/image/blog-with-nextjs-guide/16.svg" />
...
<Code content={17} data={data} image="/image/blog-with-nextjs-guide/17.svg" />
...
<Code content={18} data={data} image="/image/blog-with-nextjs-guide/18.svg" />
...
<Code content={19} data={data} image="/image/blog-with-nextjs-guide/19.svg" />
...
<Code content={20} data={data} image="/image/blog-with-nextjs-guide/20.svg" />

Here is the final code: 

<Code content={21} data={data} image="/image/blog-with-nextjs-guide/21.svg"/>
...
<Code content={22} data={data} image="/image/blog-with-nextjs-guide/22.svg" />
...
<Code content={23} data={data} image="/image/blog-with-nextjs-guide/23.svg" />
...
<Code content={24} data={data} image="/image/blog-with-nextjs-guide/24.svg" />
...
<Code content={25} data={data} image="/image/blog-with-nextjs-guide/25.svg" />
...
<Code content={26} data={data} image="/image/blog-with-nextjs-guide/26.svg" />

That should be all for our `actions.js`! Here's the final code: 

<Code content={27} data={data} image="/image/blog-with-nextjs-guide/27.svg" />