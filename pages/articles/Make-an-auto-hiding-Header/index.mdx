...
export const meta = {
  ...
  tagline: '',
  category: 'Web Dev',
  tags: ['web', 'guide', 'html', 'css', 'javascript'],
...
<Code content={0} data={data} image="/image/make-auto-hide-header/0.svg" />
...
<Code content={1} data={data} image="/image/make-auto-hide-header/1.svg"/>
...
<Code content={2} data={data} image="/image/make-auto-hide-header/2.svg"/>
...
<Code content={3} data={data} image="/image/make-auto-hide-header/3.svg"/>

Now we will add the states that we will be controlling within our `Header` component. 

<Code content={4} data={data} image="/image/make-auto-hide-header/4.svg"/>
...
<Code content={5} data={data} image="/image/make-auto-hide-header/5.svg"/>
...
<Code content={6} data={data} image="/image/make-auto-hide-header/6.svg"/>
...
<Code content={7} data={data} image="/image/make-auto-hide-header/7.svg" />
...
<Code content={8} data={data} image="/image/make-auto-hide-header/8.svg" />
...
<Code content={9} data={data} image="/image/make-auto-hide-header/9.svg" />
